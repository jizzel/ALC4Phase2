...
public class FirebaseUtil {
    ...
    public static void openFbReference(String rf, final ListActivity callerActivity) {
    ...
    private static void checkAdmin(String userId) {
        ...
        DatabaseReference rf = mFirebaseDatabase.getReference().child("administrators").child(userId);
        ...
        rf.addChildEventListener(listener);
    }
